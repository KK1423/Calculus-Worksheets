...
\noindent Write, but do not evaluate, an expression that finds the volume formed by revolving these regions around these lines. (By yourself)
\begin{enumerate}
...
\item {The region, in the first quadrant, below $y=x^3$ and to the left of $x=3$
\enumerate[label=(\alph*)]{
\begin{multicols}{3}
\item {The x-axis.}
\item {The y-axis.}
